...
console.log(regularUser.fullName); // Output: { userFullName: { firstName: "Tanish", lastName: "Choudhary" } }
console.log(regularUser.fullName.userFullName.firstName); // Output: "Tanish"
